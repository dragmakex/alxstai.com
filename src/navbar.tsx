...
function Navbar(props:NavbarProps) {
    ...
    return (
        <div className="">
            <nav className={`py-8 mb-8 md:py-8 md:mb-2 2xl:mb-10 2xl:py-20 flex justify-between transition-all duration-700 ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}> 
