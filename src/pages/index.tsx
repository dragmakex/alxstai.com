    ...
    <div className={`${videoOff ? 'videoOff' : ''} ${darkMode ? 'dark' : ''} `}>      
      ...
      <main className={`px-10 md:px-20 lg:px-40 dark:bg-black ${videoOff && !darkMode ? 'bg-gray-300' : '' }`}>
        ...
        <section className="min-h-screen"> 
          ...
          {/*<div className='text-5xl flex justify-center gap-20 py-3 text-gray-900 dark:text-gray-400'>
            <a href="https://github.com/dragmakex" target='_blank'>
              <AiFillGithub />
            </a>
            <a href="https://twitter.com/dragmakex" target='_blank'>
              <AiFillTwitterCircle />
            </a>
            <a href="https://linkedin.com/in/astaikov" target='_blank'>
              <AiFillLinkedin />
            </a>
            </div>*/}
          {/*<div className={`inset-0 border-8 border-gray-400 dark:border-white flex items-center relative mx-auto rounded-full w-80 h-80 mt-24 overflow-hidden md:h-96 md:w-96 dark:bg-gray-400 bg-black transition-all duration-700 ${loaded ? 'opacity-100 translate-y-10' : 'opacity-0 translate-y-0'}`}>
